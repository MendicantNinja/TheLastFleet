...
@export var shield_raise_time: float = 1.0 				  # How many seconds does it take to raise the shields?
@export var shield_efficiency: float = 1.0          # How effective the shields are at blocking damage
