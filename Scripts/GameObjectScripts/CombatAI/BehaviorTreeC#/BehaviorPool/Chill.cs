...
public partial class Chill : Action
{
	public override NodeState Tick(Node agent)
	{
		...
		if (steer_data.TargetPosition != Vector2.Zero || IsInstanceValid(ship_wrapper.TargetUnit) || ship_wrapper.FallbackFlag == true || ship_wrapper.RetreatFlag == true || ship_wrapper.TargetedUnits.Count > 0)
		{
