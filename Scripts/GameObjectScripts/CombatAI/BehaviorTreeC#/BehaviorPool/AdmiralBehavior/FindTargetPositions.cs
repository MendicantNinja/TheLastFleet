...
public partial class FindTargetPositions : Action
{
    public override NodeState Tick(Node agent)
    {
        ...
        ICollection<Vector2I> goal_positions;
        ...
        List<Godot.Collections.Array<Vector2I>> skip_clusters = new List<Godot.Collections.Array<Vector2I>>();
        ...
        {
            if (skip_clusters.Contains(cluster)) continue;
